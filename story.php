...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Story Pasangan</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                <h5 class="card-title">Story Pasangan</h5>
                <button type="button" class="btn btn-primary" onclick="window.location.href='addstory.php';">
                    <i class="bx bxs-duplicate"></i> Tambahkan Story Pasangan
                </button>

                <p>Data berikut adalah Story Pasangan.</p>
                ...
                <tbody>
                    ...
                    $sql = "SELECT id, title, tanggal,keterangan, foto FROM story";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            if (!empty($row['foto'])) {
                                echo "<img src='img/foto-story/" . htmlspecialchars($row['foto']) . "' alt='Foto Story' width='100' class='img-thumbnail'>";
                            } else {
                            ...
                            echo "</td>
                                    <td>
                                        <button type='button' class='btn btn-warning' onclick=\"window.location.href='editstory.php?id={$row['id']}';\">
                                            <i class='bi bi-exclamation-triangle'></i> Edit
                                        </button>
                                        <button type='button' class='btn btn-danger' onclick=\"window.location.href='hapusstory.php?id={$row['id']}';\">
